          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="container">
                ...
                @endif
                <div class="card">
                  <div class="card-header bg-info text-white">Editer un Secteur</div>
                  <div class="card-body">
                    <form action="{{route('secteurs.update',$secteur->id)}}" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="libelle" id="" class="form-control" value="{{$secteur->libelle}}">
                      </div>

                      <!-- <div class="form-group">
                        <label for="couleur">Choisir une couleur :</label>
                        <select id="" name="couleur" class="form-select" value="{{$secteur->couleur}}">
                      ...
                      <!-- <div class="form-group">
                        ...
                        <input type="text" name="icon" id="" class="form-control" value="{{$secteur->icon}}">
